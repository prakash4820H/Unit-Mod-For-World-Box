...
namespace Unit
{
    class UnitBiomes
    {
        ...
        public static void Init()
        {
            ...
            deep_blood.layerType = TileLayerType.Ocean;
            deep_blood.canBeRemovedWithBucket = true;
            deep_blood.canBuildOn = true;
            deep_blood.damageUnits = true;
            deep_blood.damage = 150;
            ...
            close_blood.layerType = TileLayerType.Ocean;
            close_blood.liquid = true;
            close_blood.ocean = true;
            close_blood.heightMin = 70;
            close_blood.damageUnits = true;
            close_blood.damage = 150;
            ...
            shallow_blood.layerType = TileLayerType.Ocean;
            shallow_blood.ocean = true;
            shallow_blood.damageUnits = true;
            shallow_blood.damage = 150;
